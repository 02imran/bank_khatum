...
class ValidateCustomerOtpResponse {
  ValidateCustomerOtpResponse({
      String? msisdn, 
      int? responseCode, 
  ...
  ValidateCustomerOtpResponse.fromJson(dynamic json) {
    _msisdn = json['Msisdn'];
  ...
  dynamic _data;
ValidateCustomerOtpResponse copyWith({  String? msisdn,
  int? responseCode,
  String? responseDescription,
  dynamic responseDescriptionLocal,
  dynamic transactionId,
  dynamic data,
}) => ValidateCustomerOtpResponse(  msisdn: msisdn ?? _msisdn,
