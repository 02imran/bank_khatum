...
class CashInController extends GetxController with StateMixin {
  ...
  checkCashIn(BuildContext context) {
                ...
                SharedPrefsHelper.getMsisdn().then((msisdn) => {
                  SharedPrefsHelper.getBasicToken().then((token) => {
                    getOs().then((os)  async {
                      ...
                      var amlBody=AmlBody(amount: amount,currency: "XCD",customerMsisdn: "",destinationMsisdn: mobilePrefix+phone,keyword:"CASH",msisdn: msisdn,pin:pinController.text  );
                      ...
                      if(response.responseCode==100){
                        ...
                        Get.to( TransactionOverviewScreen(),arguments: [response,pin,"",response.keyword,"","", mobilePrefix+phone]);
                      }else{
                        pinController.text="";
                        DialogHelper.hideLoading();
                        Fluttertoast.showToast(
