...
class BuildCurentPinFormField extends GetView<UpdatePinController>{

  const BuildCurentPinFormField({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return TextFormField(
      controller: controller.curentPinController,
      ...
      decoration: const InputDecoration(
        counterText: "",
        labelText: "Enter Current 4-Digit PIN",
