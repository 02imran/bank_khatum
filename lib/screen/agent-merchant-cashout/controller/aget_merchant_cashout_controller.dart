...
class AgentMerchantCashOutController  extends GetxController with StateMixin{
      ...
      return Container(
        ...
        child: Column(
             ...
             children:   <Widget>[
               ...
               const Text("Enter Merchant Details",style: TextStyle(fontSize: 17,color: Colors.black),),
                ...
                SharedPrefsHelper.getMsisdn().then((msisdn) => {
                  SharedPrefsHelper.getBasicToken().then((token) => {
                    getOs().then((os)  async {
                      ...
                      var amlBody=AmlBody(amount: amount,currency: "XCD",customerMsisdn: mobilePrefix+phoneController.text,destinationMsisdn: msisdn,keyword:"MGIV",msisdn: msisdn,pin:pin  );
