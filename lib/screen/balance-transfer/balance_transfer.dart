...
import 'controller/balance_transfer_controller.dart';

class BalanceTransferScreen extends GetView<BalanceTransferController>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Balance Transfer",style: TextStyle(color: Colors.white),),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          controller.checkBalanceTransfer(context);
