...
class BalanceTransferController extends GetxController with StateMixin {
  ...
  checkBalanceTransfer(BuildContext context) {
                ...
                SharedPrefsHelper.getMsisdn().then((msisdn) => {
                  SharedPrefsHelper.getBasicToken().then((token) => {
                    getOs().then((os)  async {
                      ...
                      var amlBody=AmlBody(amount: amount,currency: "XCD",customerMsisdn: "",destinationMsisdn: mobilePrefix+phone,keyword:"CAST",msisdn: msisdn,pin:pinController.text  );
